...
<html>
  ...
  <source src="../../images/login.mp4" type="video/mp4">
            ...
            <h2>Dealer Login</h2> <br><br><br><br>
...
if(isset($_POST['but_submit'])){
    ...
    if ($uname != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from dlr where usr_nm='".$uname."' and passwd='".$password."'";
        ...
        $count = $row['cntUser'];
         ...
         $sql_query1 = "select * from dlr where usr_nm='".$uname."'";
        ...
        if($count > 0){
            ...
            header('Location: dashboard.php?id='.$row1['id'].'');
        }else{
